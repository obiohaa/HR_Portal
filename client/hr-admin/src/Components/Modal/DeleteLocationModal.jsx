...
const DeleteLocationModal = ({ deletedItem }) => {
  ...
  const { mutate: deleteLocation, isLoading } = useMutation({
    mutationFn: async (deleteLocation) =>
      axiosFetch.delete("/admins/deleteLocation", { data: { ids: deleteLocation } }),
    onSuccess: (data) => {
      closeDelModal();
            ...
            <div className="contentM">
              <div className="container">
                ...
                {deletedItem.length > 1
                  ? `You are about to delete ${deletedItem.length} locations, if you are sure of this action, click on the delete button else cancel button`
                  : `You are about to delete ${deletedItem.length} location, if you are sure of this action, click on the delete button else cancel button`}
              </div>
